from models.mlp import MLPLOB
from models.transformer import TransformerLOB
...
def pick_model(model_type, hidden_dim, num_layers, seq_size, num_features, num_heads=8, is_sin_emb=False, dataset_type=None):
    if model_type == "MLP":
        ...
        return TransformerLOB(hidden_dim, num_layers, seq_size, num_features, num_heads, is_sin_emb, dataset_type)
